...
from sam.metrics.weak_span_based_f1_measure import SpanBasedF1WeakMeasure
from sam.utils import normalize_span_f1_result, flatten_dict


@Model.register("crf_tagger_with_f1")
class CrfTaggerWithF1(Model):
    ...
    def __init__(
        ...
        calculate_weak_span_f1: bool = None,
        ...
        **kwargs,
        ...
        if self.calculate_weak_span_f1:
            ...
            self._weak_f1_metric = SpanBasedF1WeakMeasure(
                vocab, tag_namespace=label_namespace, label_encoding=label_encoding, weak=True
            )
    ...
    def forward(
        ...
        **kwargs,  # to allow for a more general dataset reader that passes args we don't need
        ...
        if tags is not None:
            ...
            if self.calculate_weak_span_f1:
                self._weak_f1_metric(class_probabilities, tags, mask)
